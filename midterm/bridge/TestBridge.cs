...
namespace DesignPatterns
{
    ...
    public class TestBridge
    {
        ...
        public void TestDefaultStackArrayCreation()
        {
            ...
            Assert.AreEqual(stackArray.items.Length, new int[12].Length);
        ...
        public void TestStackArrayWithProvidedNumberOfCells()
        {
            ...
            Assert.AreEqual(stackArray.items.Length, new int[cells].Length);
            Assert.AreEqual(stackArray.size, -1);
        ...
        public void TestStackArrayPush()
        {
            ...
            Assert.AreEqual(stackArray[0], 1);
            ...
            Assert.AreEqual(stackArray[1], 2);
            Assert.AreEqual(stackArray.size, 1);
        ...
        public void TestStackArrayPeek()
        {
            ...
            Assert.AreEqual(stackArray.peek(), stackArray[1]);
            Assert.AreEqual(stackArray.size, 1);
        ...
        public void TestStackArrayPop()
        {
            ...
            Assert.AreEqual(stackArray.pop(), stackArray[0]);
            Assert.AreEqual(stackArray.size, 0);
